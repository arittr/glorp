...
fn blocked_provider_state_renders_calm_setup_view() {
    ...
    vm.source_health = vec![SourceHealthView {
        ...
        snapshot_state: glorp::usage::snapshot::SnapshotState::Missing,
...
fn source_health_rows_render_ready_and_diagnostic_states_together() {
    ...
    vm.source_health = vec![
        SourceHealthView {
            ...
            snapshot_state: glorp::usage::snapshot::SnapshotState::Current,
            snapshot_reason: None,
...
fn pet_panel_draw_order_keeps_pet_above_habitat_props() {
    ...
    let fn_body = source
        ...
        .nth(1)
        .expect("render_pet_to_draw_list body");
    let ambient = fn_body
        .find("ambient_glyphs_for_phase(")
        .or_else(|| fn_body.find("ambient_glyphs_for("))
